...
save_path = 'D:\\DATA_STORAGE\\EXTRACTED\\IMG\\KUMC\\TEST\\12stack_sample\\'
...
# Get sample df
label_list = df_info['temp_Label'].unique()

sample_list = pd.DataFrame()
for l in label_list:
    df_label = df_info[df_info['temp_Label']==l]
    temp_list = pd.DataFrame(df_label['filename'].sample(n=3))
    sample_list = sample_list.append(temp_list)
...
df_total = df_total[df_total['filename'].isin(sample_list['filename'])].reset_index(drop=True)
...
for i in range(1,len(pkl_files)):
    ...
    print(pkl_files[i])
# I
df_lead1 = df_total[df_total['lead']=='lead1'].reset_index(drop=True)
# II
df_lead2 = df_total[df_total['lead']=='lead2'].reset_index(drop=True)
# III
df_lead3 = df_total[df_total['lead']=='lead3'].reset_index(drop=True)
# aVR
df_lead4 = df_total[df_total['lead']=='lead4'].reset_index(drop=True)
# aVL
df_lead5 = df_total[df_total['lead']=='lead5'].reset_index(drop=True)
# aVF
df_lead6 = df_total[df_total['lead']=='lead6'].reset_index(drop=True)
# V1
df_lead7 = df_total[df_total['lead']=='lead7'].reset_index(drop=True)
# V2
df_lead8 = df_total[df_total['lead']=='lead8'].reset_index(drop=True)
# V3
df_lead9 = df_total[df_total['lead']=='lead9'].reset_index(drop=True)
# V4
df_lead10 = df_total[df_total['lead']=='lead10'].reset_index(drop=True)
# V5
df_lead11 = df_total[df_total['lead']=='lead11'].reset_index(drop=True)
# V6
df_lead12 = df_total[df_total['lead']=='lead12'].reset_index(drop=True)
...
# set
imgNum = 0
for imgNum in tqdm(range(0,len(lead1))): #len(lead1)
